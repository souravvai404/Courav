...
const doNotDelete = "[ 𝚂𝙾𝚄𝚁𝙰𝚅 ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += `\n\n╭─────❃[✨𝙴𝙽𝙹𝙾𝚈✨]\n |[✨𝚈𝙾𝚄𝚁 𝚂𝙾𝚄𝚁𝙰𝚅✨]\n | [ 🍀𝙹𝙾𝙸𝙽 𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝚃𝚈𝙿𝙴: ${prefix}𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝙶𝙲 ]\n | [✨𝙳𝙰𝚈𝚁𝙴𝙲𝚃 𝙶𝚁𝙾𝚄𝙿 𝙻𝙸𝙽𝙺: https://www.facebook.com/s.o.u.r.a.v.tsu.941375 ]\n│>𝚃𝙾𝚃𝙰𝙻 𝙲𝙼𝙳𝚂: [✨${totalCommands}✨].\n│𝚃𝚈𝙿𝙴:[ 🍀${prefix}𝙷𝙴𝙻𝙿 𝚃𝙾✨\n│✨<𝙲𝙼𝙳> 𝚃𝙾 𝙻𝙴𝙰𝚁𝙽 𝚃𝙷𝙴 𝚄𝚂𝙰𝙶𝙴.]\n╰────────────✦`;
      msg += ``;
      msg += `\n╭─────❃\n│ 🌟 | [✨𝙶𝙾𝙰𝚃𝙱𝙾𝚃🐐\n │𝙾𝚆𝙽𝙴𝚁 𝙵𝙱 𝙸𝙳:  https://www.facebook.com/s.o.u.r.a.v.tsu.941375\n╰────────────✦`;            
        await message.reply({
        body: msg,
      });
    } else {
 ...
 │ ${usage}
 ├──✨𝐍𝐨𝐭𝐞𝐬✨
 │ ⚡𝚃𝚑𝚎 𝚌𝚘𝚗𝚝𝚎𝚗𝚝 inside <𝚂𝙾𝚄𝚁𝙰𝚅> 𝚌𝚊𝚗 𝚋𝚎 𝚌𝚑𝚊𝚗𝚐𝚎𝚍
